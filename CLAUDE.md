...
- `BUSINESS-PLAN.md` — the full VNK Digital / Darius Builds business plan (speed-led positioning, pricing, delivery system, 12-month roadmap). **This is the strategy source of truth.** Pricing decision 2026-07-02: keep live prices (e-commerce R15,000, custom apps R25,000); raises are future options gated on case studies.
